...
class AddPassword : public Command {
public:
    AddPassword(std::vector<passwordRecords> &passwords, const string &key) : passwords(passwords),
                                                                              encryptionKey(key) {}
...
class GeneratePassword : public Command {
public:
...
class ViewAllPasswords : public Command {
public:
    ViewAllPasswords(const std::vector<passwordRecords> &passwords, const string &key) : passwords(passwords),
                                                                                         encryptionKey(key) {}
...
private:
    const std::vector<passwordRecords> &passwords;
    const std::string &encryptionKey;
};

class UpdatePassword : public Command {
public:
    UpdatePassword(std::vector<passwordRecords> &passwords, const string &key) : passwords(passwords),
                                                                                 encryptionKey(key) {}
...
class DeletePassword : public Command {
public:
    explicit DeletePassword(std::vector<passwordRecords> &passwords) : passwords(passwords) {}
...
class ChangePrimaryKey : public Command {
public:
    ChangePrimaryKey(std::vector<passwordRecords> &passwords, string &key) : passwords(passwords), encryptionKey(key) {}
...
class SearchPasswords : public Command {
public:
    SearchPasswords(const std::vector<passwordRecords> &passwords, const string &key) : passwords(passwords),
                                                                                        encryptionKey(key) {};
...
class ImportPasswords : public Command {
public:
    ImportPasswords(std::vector<passwordRecords> &passwords, const string &key) : passwords(passwords),
                                                                                  encryptionKey(key) {};
        ...
        if (!duplicates.empty()) {
            ...
            if (validateYesNo()) {
                ...
                passwords.erase(std::remove_if(passwords.begin(), passwords.end(),
                                               [&duplicates](const auto &password) -> bool {
                                                   return std::ranges::binary_search(duplicates,
                                                                                     password,
                                                                                     [](const auto &tuple1,
                                                                                        const auto &tuple2) {
                                                                                         return comparator(tuple1,
                                                                                                           tuple2);
                                                                                     });
                                               }), passwords.end());
            } else {
...
class ExportPasswords : public Command {
public:
    ExportPasswords(std::vector<passwordRecords> &passwords, const string &key) : passwords(passwords),
                                                                                  encryptionKey(key) {};
...
class AnalyzePasswords : public Command {
public:
    AnalyzePasswords(const std::vector<passwordRecords> &passwords, const string &key) : passwords(passwords),
                                                                                         encryptionKey(key) {};
...
void passwordManager() {
    ...
    while (true) {
        ...
        switch (choice) {
            case 1:
                command = std::make_unique<AddPassword>(passwords, encryptionKey);
                break;
            case 2:
                command = std::make_unique<GeneratePassword>();
                break;
            case 3:
                command = std::make_unique<ViewAllPasswords>(passwords, encryptionKey);
                break;
            case 4:
                command = std::make_unique<UpdatePassword>(passwords, encryptionKey);
                break;
            case 5:
                command = std::make_unique<DeletePassword>(passwords);
                break;
            case 6:
                command = std::make_unique<ChangePrimaryKey>(passwords, encryptionKey);
                break;
            case 7:
                command = std::make_unique<SearchPasswords>(passwords, encryptionKey);
                break;
            case 8:
                command = std::make_unique<ImportPasswords>(passwords, encryptionKey);
                break;
            case 9:
                command = std::make_unique<ExportPasswords>(passwords, encryptionKey);
                break;
            case 10:
                command = std::make_unique<AnalyzePasswords>(passwords, encryptionKey);
                break;
            case 11:
                break;
            default:
